...
namespace Crosstales.RTVoice.Util
{
   ...
   public abstract class Constants : Crosstales.Common.Util.BaseConstants
   {
      ...
      public const string ASSET_VERSION = "2024.1.0";

      /// <summary>Build number of the asset.</summary>
      public const int ASSET_BUILD = 20240127;
      ...
      public static readonly System.DateTime ASSET_CHANGED = new System.DateTime(2024, 1, 27);
